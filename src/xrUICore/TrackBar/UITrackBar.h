...
public:
	...
	int		GetIValueMin() { return m_i_min; }
	float	GetFValueMin() { return m_f_min; }
	int		GetIValueMax() { return m_i_max; }
	float	GetFValueMax() { return m_f_max; }
	bool	IsNumberFloat() { return m_b_is_float; };
