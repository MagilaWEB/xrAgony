...
public:
	...
	virtual void Activate(
		const Fmatrix& transform, const Fvector& lin_vel, const Fvector& ang_vel, bool disable = false) = 0;
...
class XRPHYSICS_API CPhysicsElement : public CPhysicsBase, public IPhysicsElement
{
public:
	u16 m_SelfID;
...
class XRPHYSICS_API CPhysicsShell : public CPhysicsBase, public IPhysicsShell
{
protected:
...
public:
	...
	virtual void applyHit(
		const Fvector& pos, const Fvector& dir, float val, const u16 id, ALife::EHitType hit_type) = 0;
...
XRPHYSICS_API CPhysicsJoint* P_create_Joint(
	CPhysicsJoint::enumType type, CPhysicsElement* first, CPhysicsElement* second);
