...
namespace CDB
{
	...
	public:
		...
		void ray_query(const u32 ray_mode, const MODEL* m_def, const Fvector& r_start, const Fvector& r_dir, float r_range = 10000.f);

		void box_query(const u32 box_mode, const MODEL* m_def, const Fvector& b_center, const Fvector& b_dim);

		void frustum_query(const u32 frustum_mode, const MODEL* m_def, const CFrustum& F);
