...
struct test_property
{
    ...
    int __stdcall getter() { return m_property; }
    void __stdcall setter(int value) { m_property = value; }
};
...
struct test_property2
{
    ...
    pcstr __stdcall getter() { return m_property; }
    void __stdcall setter(pcstr value)
    {
        xr_free(m_property);
...
struct test_property4
{
    ...
    bool __stdcall getter() { return m_property; }
    void __stdcall setter(bool value) { m_property = value; }
};
...
struct test_property6
{
    ...
    editor::color __stdcall getter() { return m_property; }
    void __stdcall setter(editor::color value) { m_property = value; }
};
...
struct test_property7
{
    ...
    float __stdcall getter() { return m_property; }
    void __stdcall setter(float value) { m_property = value; }
};
