...
public:
	float grass_level_scale{ 1.f };
	float grass_level_density{ 1.f };
	...
	virtual void add_Visual(IRenderVisual* V, bool bIgnoreOpt = false) = 0; // add visual leaf (no culling performed at all)
...
public:
	...
	virtual void ResourcesWaitTexturesLoad() = 0;
