...
void CScriptGameObject::set_force_anti_aim(bool force)
{
	...
	if (!monster)
	{
		::ScriptEngine->script_log(LuaMessageType::Error, "object is not CBaseMonster to call set_force_anti_aim");
		return;
	}
...
bool CScriptGameObject::get_force_anti_aim()
{
	...
	if (!monster)
	{
		::ScriptEngine->script_log(LuaMessageType::Error, "object is not CBaseMonster to call get_force_anti_aim");
		return false;
	}
...
void CScriptGameObject::set_override_animation(pcstr anim_name)
{
	...
	if (!monster)
	{
		::ScriptEngine->script_log(LuaMessageType::Error, "object is not of CBaseMonster class!");
		return;
	}
...
CScriptSoundInfo CScriptGameObject::GetSoundInfo()
{
	...
	{
		::ScriptEngine->script_log(
			LuaMessageType::Error, "CScriptGameObject : cannot access class member GetSoundInfo!");
	}
	return (ret_val);
}
...
CScriptMonsterHitInfo CScriptGameObject::GetMonsterHitInfo()
{
	...
	{
		::ScriptEngine->script_log(
			LuaMessageType::Error, "CScriptGameObject : cannot access class member GetMonsterHitInfo!");
	}
	return (ret_val);
}
