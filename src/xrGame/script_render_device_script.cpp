...
SCRIPT_EXPORT(CRenderDevice, (), {
	module(luaState)[class_<CRenderDevice>("render_device")
						 ...
						 .def("time_delta_ms", &CRenderDevice::TimeDelta_ms)
						 .def("time_delta_sec", &CRenderDevice::TimeDelta_sec)
						 ...
						 .def("time_global", &CRenderDevice::TimeGlobal_ms)
						 .def_readonly("precache_frame", &CRenderDevice::dwPrecacheFrame)
						 .def("frame", &CRenderDevice::getFrame)
