...
SCRIPT_EXPORT(fs_registrator, (), {
	...
	*/
	...
	class_<CLocatorAPI>("FS")
		...
		.def("win_file_delete", (void (CLocatorAPI::*)(LPCSTR, LPCSTR))(&CLocatorAPI::win_file_delete))
		.def("win_file_delete", (void (CLocatorAPI::*)(LPCSTR))(&CLocatorAPI::win_file_delete))

		.def("win_dir_delete", (bool (CLocatorAPI::*)(LPCSTR, LPCSTR))(&CLocatorAPI::win_dir_delete))
		.def("win_dir_delete", (bool (CLocatorAPI::*)(LPCSTR))(&CLocatorAPI::win_dir_delete))
