...
IC float const& loophole::danger_fov() const { return (m_danger_fov); }
IC float const& loophole::range() const { return (m_range); }
IC Fvector const& loophole::fov_position() const { return (m_fov_position); }
IC Fvector const& loophole::fov_direction() const { return (m_fov_direction); }
IC Fvector const& loophole::danger_fov_direction() const { return (m_danger_fov_direction); }
IC Fvector const& loophole::enter_direction() const { return (m_enter_direction); }
IC loophole::ActionList const& loophole::actions() const { return (m_actions); }
IC bool const& loophole::enterable() const { return (m_enterable); }
IC void loophole::enterable(bool value) { m_enterable = value; }
