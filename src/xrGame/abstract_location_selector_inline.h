...
TEMPLATE_SPECIALIZATION
IC void CSelectorTemplate::set_evaluator(_VertexEvaluator* evaluator) { m_evaluator = evaluator; }
TEMPLATE_SPECIALIZATION
IC void CSelectorTemplate::set_query_interval(const u32 query_interval) { m_query_interval = query_interval; }
TEMPLATE_SPECIALIZATION
...
TEMPLATE_SPECIALIZATION
IC bool CSelectorTemplate::failed() const { return (m_failed); }
TEMPLATE_SPECIALIZATION
IC bool CSelectorTemplate::used() const { return (m_evaluator && m_graph); }
TEMPLATE_SPECIALIZATION
