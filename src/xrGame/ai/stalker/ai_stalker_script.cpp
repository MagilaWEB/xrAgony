	...
	module(luaState)
		[class_<CStalkerPlanner, CScriptActionPlanner>("stalker_ids")
				.enum_("properties")[luabind::value("property_alive", StalkerDecisionSpace::eWorldPropertyAlive),
					...
					luabind::value(
						"property_use_crouch_to_look_out", StalkerDecisionSpace::eWorldPropertyUseCrouchToLookOut),
					luabind::value(
						"property_critically_wounded", StalkerDecisionSpace::eWorldPropertyCriticallyWounded),
					...
					luabind::value(
						"property_danger_in_direction", StalkerDecisionSpace::eWorldPropertyDangerInDirection),
				...
				.enum_("action")[luabind::value("action_dead", StalkerDecisionSpace::eWorldOperatorDead),
					...
					luabind::value(
						"action_reach_customer_location", StalkerDecisionSpace::eWorldOperatorReachCustomerLocation),
					...
					luabind::value(
						"action_kill_enemy_if_not_visible", StalkerDecisionSpace::eWorldOperatorKillEnemyIfNotVisible),
					luabind::value("action_reach_wounded_enemy", StalkerDecisionSpace::eWorldOperatorReachWoundedEnemy),
					luabind::value(
						"action_prepare_wounded_enemy", StalkerDecisionSpace::eWorldOperatorPrepareWoundedEnemy),
					...
					luabind::value(
						"action_danger_unknown_planner", StalkerDecisionSpace::eWorldOperatorDangerUnknownPlanner),
					luabind::value("action_danger_in_direction_planner",
						StalkerDecisionSpace::eWorldOperatorDangerInDirectionPlanner),
					luabind::value(
						"action_danger_grenade_planner", StalkerDecisionSpace::eWorldOperatorDangerGrenadePlanner),
					luabind::value(
						"action_danger_by_sound_planner", StalkerDecisionSpace::eWorldOperatorDangerBySoundPlanner),

					luabind::value(
						"action_danger_unknown_take_cover", StalkerDecisionSpace::eWorldOperatorDangerUnknownTakeCover),
					luabind::value("action_danger_unknown_look_around",
						StalkerDecisionSpace::eWorldOperatorDangerUnknownLookAround),
					luabind::value(
						"action_danger_unknown_search", StalkerDecisionSpace::eWorldOperatorDangerUnknownSearchEnemy),
					...
					luabind::value(
						"action_danger_grenade_take_cover", StalkerDecisionSpace::eWorldOperatorDangerGrenadeTakeCover),
				...
				.enum_("sounds")[luabind::value("sound_die", StalkerSpace::eStalkerSoundDie),
					...
					luabind::value(
						"sound_attack_allies_single_enemy", StalkerSpace::eStalkerSoundAttackAlliesSingleEnemy),
					luabind::value(
						"sound_attack_allies_several_enemies", StalkerSpace::eStalkerSoundAttackAlliesSeveralEnemies),
					...
					luabind::value(
						"sound_enemy_killed_or_wounded", StalkerSpace::eStalkerSoundMaskEnemyKilledOrWounded),
