...
public:
	...
	bool home_in_danger() { return ::IDevice->TimeGlobal_ms() < m_home_danger_end_tick; }
	void set_home_in_danger() { m_home_danger_end_tick = ::IDevice->TimeGlobal_ms() + m_home_danger_mode_time; }
