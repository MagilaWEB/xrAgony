...
{
	this->add_state(eStateControlled_Follow_Wait, new CStateMonsterCustomAction<_Object>(obj));
	this->add_state(eStateControlled_Follow_WalkToObject, new CStateMonsterMoveToPointEx<_Object>(obj));
}
