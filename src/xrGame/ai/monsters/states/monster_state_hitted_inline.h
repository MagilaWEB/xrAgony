...
{
	this->add_state(eStateHitted_Hide, new CStateMonsterHittedHide<_Object>(obj));
	this->add_state(eStateHitted_MoveOut, new CStateMonsterHittedMoveOut<_Object>(obj));
	this->add_state(eStateHitted_Home, new CStateMonsterDangerMoveToHomePoint<_Object>(obj));
}
