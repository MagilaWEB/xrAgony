...
{
	this->add_state(eStateAttackCamp_Hide, new CStateMonsterMoveToPointEx<_Object>(obj));
	this->add_state(eStateAttackCamp_Camp, new CStateMonsterLookToPoint<_Object>(obj));
	this->add_state(eStateAttackCamp_StealOut, new CStateMonsterAttackCampStealOut<_Object>(obj));
}
