...
{
	this->add_state(eStateHearHelpSound_MoveToDest, new CStateMonsterMoveToPointEx<_Object>(obj));
	this->add_state(eStateHearHelpSound_LookAround, new CStateMonsterCustomActionLook<_Object>(obj));
}
