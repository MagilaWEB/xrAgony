...
SCRIPT_EXPORT(CScriptAnimationAction, (), {
	module(luaState)[class_<CScriptAnimationAction>("anim")
						 .enum_("type")[value("free", int(MonsterSpace::eMentalStateFree)),
							 value("danger", int(MonsterSpace::eMentalStateDanger)),
							 value("panic", int(MonsterSpace::eMentalStatePanic))]
						 .enum_("monster")[value("stand_idle", int(MonsterSpace::eAA_StandIdle)),
							 ...
							 value("eat", int(MonsterSpace::eAA_Eat)), value("sleep", int(MonsterSpace::eAA_Sleep)),
