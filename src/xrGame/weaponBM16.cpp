...
void CWeaponBM16::PlayAnimIdle()
{
	...
	if (IsZoomed())
	{
		switch (m_magazine.size())
		{
		case 0: { PlayHUDMotion("anm_idle_aim_0", TRUE, nullptr, GetState());
		}
		break;
		case 1: { PlayHUDMotion("anm_idle_aim_1", TRUE, nullptr, GetState());
		}
		break;
		case 2: { PlayHUDMotion("anm_idle_aim_2", TRUE, nullptr, GetState());
		}
		break;
		};
	}
	else
	{
		switch (m_magazine.size())
		{
		case 0: { PlayHUDMotion("anm_idle_0", TRUE, nullptr, GetState());
		}
		break;
		case 1: { PlayHUDMotion("anm_idle_1", TRUE, nullptr, GetState());
		}
		break;
		case 2: { PlayHUDMotion("anm_idle_2", TRUE, nullptr, GetState());
		}
		break;
		};
	}
