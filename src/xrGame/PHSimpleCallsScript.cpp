...
SCRIPT_EXPORT(CPHCallOnStepCondition, (), {
	module(luaState)[class_<CPHCallOnStepCondition>("phcondition_callonstep")
...
SCRIPT_EXPORT(CPHExpireOnStepCondition, (CPHCallOnStepCondition), {
	module(luaState)[class_<CPHExpireOnStepCondition, CPHCallOnStepCondition>("phcondition_expireonstep")
						 .def(constructor<>())];
});

SCRIPT_EXPORT(CPHConstForceAction, (), {
	module(luaState)[class_<CPHConstForceAction>("phaction_constforce")
