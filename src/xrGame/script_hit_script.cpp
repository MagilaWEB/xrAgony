...
SCRIPT_EXPORT(CScriptHit, (), {
	module(
		luaState)[class_<CScriptHit>("hit")
					  .enum_("hit_type")[value("burn", int(ALife::eHitTypeBurn)),
						  value("shock", int(ALife::eHitTypeShock)), value("strike", int(ALife::eHitTypeStrike)),
