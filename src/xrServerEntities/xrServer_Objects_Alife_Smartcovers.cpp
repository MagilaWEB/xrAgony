...
BOOL is_combat_cover(shared_str const& table_id)
{
    ...
    bool result = ::ScriptEngine->function_object(temp, table, LUA_TTABLE);
...
void CSE_SmartCover::check_enterable_loopholes(shared_str const& description)
{
    ...
    bool result = ::ScriptEngine->function_object(temp, transitions, LUA_TTABLE);
...
void CSE_SmartCover::load_draw_data()
{
    ...
    bool result = ::ScriptEngine->function_object(temp, loopholes, LUA_TTABLE);
