...
SCRIPT_EXPORT(CSE_ALifeItemDocument, (CSE_ALifeItem),
	{ module(luaState)[luabind_class_item1(CSE_ALifeItemDocument, "cse_alife_item_document", CSE_ALifeItem)]; });

SCRIPT_EXPORT(CSE_ALifeItemGrenade, (CSE_ALifeItem),
	{ module(luaState)[luabind_class_item1(CSE_ALifeItemGrenade, "cse_alife_item_grenade", CSE_ALifeItem)]; });

SCRIPT_EXPORT(CSE_ALifeItemExplosive, (CSE_ALifeItem),
	{ module(luaState)[luabind_class_item1(CSE_ALifeItemExplosive, "cse_alife_item_explosive", CSE_ALifeItem)]; });

SCRIPT_EXPORT(CSE_ALifeItemBolt, (CSE_ALifeItem),
	{ module(luaState)[luabind_class_item1(CSE_ALifeItemBolt, "cse_alife_item_bolt", CSE_ALifeItem)]; });

SCRIPT_EXPORT(CSE_ALifeItemCustomOutfit, (CSE_ALifeItem), {
	module(luaState)[luabind_class_item1(CSE_ALifeItemCustomOutfit, "cse_alife_item_custom_outfit", CSE_ALifeItem)];
});
