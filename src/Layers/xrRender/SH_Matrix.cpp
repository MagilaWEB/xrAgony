...
void CMatrix::Calculate()
{
	...
	case modeS_refl:
	{
		float Ux = .5f * ::IDevice->cast()->mView._11, Uy = .5f * ::IDevice->cast()->mView._21, Uz = .5f * ::IDevice->cast()->mView._31, Uw = .5f;
		float Vx = -.5f * ::IDevice->cast()->mView._12, Vy = -.5f * ::IDevice->cast()->mView._22, Vz = -.5f * ::IDevice->cast()->mView._32, Vw = .5f;
