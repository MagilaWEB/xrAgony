...
//| R3FLAG_MSAA
//| R3FLAG_MSAA_OPT
| R2FLAG_DETAIL_BUMP | R2FLAG_DOF | R2FLAG_SOFT_PARTICLES | R2FLAG_SOFT_WATER |
...
float		ps_r__Detail_shadow_sun_density = 700.f;
float		ps_r__Detail_shadow_light_density = 80.f;
int			ps_r__detail_radius = 49;
int			ps_r__detail_radius_MAX = 200;
float		ps_r__detail_height = 1.f;
float		ps_r__detail_scale = .6f;
float		ps_r__detail_scale_random = .6f;
int			ps_r__detail_limit_spawn = 20;
int			ps_r__detail_limit_update = 50;
int			ps_r__details_opt_intensity = 2;
...
public:
	...
	virtual void Execute(LPCSTR args)
	{
		...
		if (RImplementation.Details)
			RImplementation.Details->detail_size();
	}
...
void xrRender_initconsole()
{
	...
	CMD4(CCC_Float, "r__detail_scale", &ps_r__detail_scale, 0.2f, 1.f);
	CMD4(CCC_Float, "r__detail_scale_random", &ps_r__detail_scale_random, 0.f, 1.f);
	CMD4(CCC_Integer, "r__detail_limit_spawn", &ps_r__detail_limit_spawn, 5, 50);
