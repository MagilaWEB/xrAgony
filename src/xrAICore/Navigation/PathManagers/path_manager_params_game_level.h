...
struct SGameLevel : public SBaseParameters<_dist_type, _index_type, _iteration_type>
{
	...
	IC SGameLevel(u32 level_id, _dist_type max_range = _dist_type(6000),
		_iteration_type max_iteration_count = _iteration_type(-1), _index_type max_visited_node_count = _index_type(-1))
